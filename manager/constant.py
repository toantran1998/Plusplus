...
COURSES_INFO = {
    ...
    'PYWEOL': {'name':'-Xây dựng và triển khai được các dự án thực tế liên quan đến Python Web chuyên sâu.Xây dựng và triển khai được các dự án thực tế về CRM, hệ thống học trực tuyến Elearning… Tham gia vào bất kì công ty tuyển dụng lập trình Web Back End Developer, đặc biệt là Python Web với Flask, Django'},
